...
<main class="main">
    ...
    <div class="page-content" >
        ...
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="contact-box text-center">
                        ...
                        <div class="social-icons social-icons-color justify-content-center">
                            ...
                            <a href="https://twitter.com/login" class="social-icon social-twitter" title="Twitter" target="_blank"><i class="icon-twitter"></i></a>
                            <a href="https://www.instagram.com/accounts/login/" class="social-icon social-instagram" title="Instagram" target="_blank"><i class="icon-instagram"></i></a>
                            <a href="https://www.youtube.com/" class="social-icon social-youtube" title="Youtube" target="_blank"><i class="icon-youtube"></i></a>
                            <a href="https://www.pinterest.com/login/" class="social-icon social-pinterest" title="Pinterest" target="_blank"><i class="icon-pinterest"></i></a>
                        </div><!-- End .soial-icons -->
                    </div><!-- End .contact-box -->
                </div><!-- End .col-md-4 -->
            </div><!-- End .row -->
            ...
            <div class="touch-container row justify-content-center" id="showcontact">
                <div class="col-md-9 col-lg-7">
                    ...
                    <form id="formcontact" method="POST" enctype="multipart/form-data" class="contact-form mb-2">
                        @csrf
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <img src="{{asset('admin_panel/loading-gif.gif')}}" id="loddet" width="70" height="70" style="display:none;" alt="">
                        <div class="text-center">
                            <button type="button" id="addnewcontaact" class="btn btn-outline-primary-2 btn-minwidth-sm">
...
$(document).on('click','#addnewcontaact',function(e){
    e.preventDefault();
    $('#loddet').show();
    ...
    $.ajax({
        ...
        success:function(res)
        {
            ...
            {
                $('#loddet').hide('600');
                $('#showcontact').load(location.href + " #showcontact");
